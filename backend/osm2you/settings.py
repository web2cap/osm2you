...
MARKERS_KIND_RELATED = MARKERS_KIND_RELATED = {
    "transportation": {
        "tag": {
            "amenity": ("bus_station",),
            "railway": ("station",),
    ...
    "shopping_supplies": {
        "tag": {
            "shop": ("supermarket", "outdoor", "camping", "convenience"),
            "amenity": ("pharmacy",),
        },
        "name": "Shopping and Supplies",
    },
    "services": {
        "tag": {
            "amenity": (
    ...
    "safety_emergency": {
        "tag": {
            "amenity": ("police", "fire_station", "emergency_phone"),
    ...
    "communication": {
        "tag": {
            "amenity": ("wifi", "charging_station"),
        },
        "name": "Communication",
    },
    "educational_facilities": {
        "tag": {
            "tourism": ("information", "visitor_centre", "museum"),
        },
        "name": "Educational Facilities",
    },
    "accommodation": {
        "tag": {
            "tourism": ("hotel", "motel", "lodge", "hostel"),
        },
        "name": "Accommodation",
    },
}
