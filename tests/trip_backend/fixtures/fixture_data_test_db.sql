...
ALTER TABLE public.auth_group OWNER TO osm;
...
ALTER TABLE public.auth_group_permissions OWNER TO osm;
...
ALTER TABLE public.auth_permission OWNER TO osm;
...
ALTER TABLE public.authtoken_token OWNER TO osm;
...
ALTER TABLE public.core_kind OWNER TO osm;
...
ALTER TABLE public.core_kindgroup OWNER TO osm;
...
ALTER TABLE public.core_marker OWNER TO osm;
...
ALTER TABLE public.core_markercluster OWNER TO osm;
...
ALTER TABLE public.core_markerkind OWNER TO osm;
...
ALTER TABLE public.core_relatedmarkerscrap OWNER TO osm;
...
ALTER TABLE public.core_story OWNER TO osm;
...
ALTER TABLE public.core_tag OWNER TO osm;
...
ALTER TABLE public.core_tagvalue OWNER TO osm;
...
ALTER TABLE public.core_updatedmarkercluster OWNER TO osm;
...
ALTER TABLE public.core_user OWNER TO osm;
...
ALTER TABLE public.core_user_groups OWNER TO osm;
...
ALTER TABLE public.core_user_user_permissions OWNER TO osm;
...
ALTER TABLE public.django_admin_log OWNER TO osm;
...
ALTER TABLE public.django_celery_beat_clockedschedule OWNER TO osm;
...
ALTER TABLE public.django_celery_beat_crontabschedule OWNER TO osm;
...
ALTER TABLE public.django_celery_beat_intervalschedule OWNER TO osm;
...
ALTER TABLE public.django_celery_beat_periodictask OWNER TO osm;
...
ALTER TABLE public.django_celery_beat_periodictasks OWNER TO osm;
...
ALTER TABLE public.django_celery_beat_solarschedule OWNER TO osm;
...
ALTER TABLE public.django_content_type OWNER TO osm;
...
ALTER TABLE public.django_migrations OWNER TO osm;
...
ALTER TABLE public.django_session OWNER TO osm;
